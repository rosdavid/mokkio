  ...
  return (
    <section className="relative px-4 py-12 md:py-16 overflow-hidden">
      ...
      <div className="relative max-w-5xl mx-auto z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-5 lg:gap-7 auto-rows-[minmax(140px,1fr)] md:auto-rows-[minmax(160px,1fr)]">
          {/* Caja principal grande, ocupa 2 columnas y 2 filas */}
          <div className="group col-span-1 sm:col-span-2 md:col-span-2 row-span-2 bg-neutral-900 border border-white/5 rounded-2xl p-4 md:p-7 flex flex-col justify-center items-center shadow-md transition-all duration-400 hover:scale-[1.04] hover:shadow-purple-500/30 hover:bg-white/10 hover:backdrop-blur-md hover:border-purple-400/40 relative overflow-hidden">
            ...
            <div className="relative z-10 w-full h-full flex flex-col justify-center items-center">
              <Smartphone className="w-8 md:w-10 h-8 md:h-10 mb-2 md:mb-3 text-purple-300 group-hover:text-purple-200 transition-all duration-300" />
          ...
          <div className="group col-span-1 md:col-span-1 row-span-1 bg-neutral-900 border border-white/5 rounded-2xl p-4 md:p-7 flex flex-col items-center shadow-md transition-all duration-400 hover:scale-105 hover:shadow-pink-500/20 hover:bg-white/10 hover:backdrop-blur-md hover:border-pink-400/40 relative overflow-hidden">
            {/* Background decorativo de la caja */}
            ...
            <div className="relative z-10 w-full h-full flex flex-col items-center">
              <Palette className="w-7 md:w-9 h-7 md:h-9 mb-2 text-pink-300 group-hover:text-pink-200 transition-all duration-300" />
              <h3 className="text-sm md:text-base font-semibold text-white mb-1">
                Custom Backgrounds
              </h3>
              <p className="text-white/60 text-center text-xs md:text-sm">
          ...
          <div className="group col-span-1 md:col-span-1 row-span-2 bg-neutral-900 border border-white/5 rounded-2xl p-4 md:p-7 flex flex-col justify-center items-center shadow-md transition-all duration-400 hover:scale-[1.04] hover:shadow-blue-500/30 hover:bg-white/10 hover:backdrop-blur-md hover:border-blue-400/40 relative overflow-hidden">
            ...
            <div className="relative z-10 w-full h-full flex flex-col justify-center items-center">
              <Star className="w-8 md:w-10 h-8 md:h-10 mb-2 md:mb-3 text-blue-300 group-hover:text-blue-200 transition-all duration-300" />
              <h3 className="text-base md:text-lg font-semibold text-white mb-1">
                Layout Presets
              </h3>
              <p className="text-white/70 text-center text-xs md:text-sm">
          ...
          <div className="group col-span-1 sm:col-span-2 md:col-span-2 row-span-1 bg-neutral-900 border border-white/5 rounded-2xl p-4 md:p-7 flex flex-col items-center shadow-md transition-all duration-400 hover:scale-105 hover:shadow-blue-500/20 hover:bg-white/10 hover:backdrop-blur-md hover:border-blue-400/40 relative overflow-hidden">
            {/* Background decorativo de la caja */}
            ...
            <div className="relative z-10 w-full h-full flex flex-col items-center">
              <Download className="w-7 md:w-9 h-7 md:h-9 mb-2 text-blue-300 group-hover:text-blue-200 transition-all duration-300" />
              <h3 className="text-sm md:text-base font-semibold text-white mb-1">
                High-Quality Export
              </h3>
              <p className="text-white/60 text-center text-xs md:text-sm">
          ...
          <div className="group col-span-1 md:col-span-1 row-span-1 bg-neutral-900 border border-white/5 rounded-2xl p-4 md:p-7 flex flex-col items-center shadow-md transition-all duration-400 hover:scale-105 hover:shadow-purple-500/20 hover:bg-white/10 hover:backdrop-blur-md hover:border-purple-400/40 relative overflow-hidden">
            {/* Background decorativo de la caja */}
            <div className="absolute inset-0 z-0 pointer-events-none bg-linear-to-br from-purple-800/30 via-blue-800/20 to-indigo-800/30 opacity-60 blur-md"></div>
            <div className="relative z-10 w-full h-full flex flex-col items-center">
              <RotateCcw className="w-6 md:w-8 h-6 md:h-8 mb-2 text-purple-300 group-hover:text-purple-200 transition-all duration-300" />
              <h3 className="text-sm md:text-base font-semibold text-white mb-1">
                Undo/Redo
              </h3>
              <p className="text-white/60 text-center text-xs md:text-sm">
          ...
          <div className="group col-span-1 md:col-span-1 row-span-1 bg-neutral-900 border border-white/5 rounded-2xl p-4 md:p-7 flex flex-col items-center shadow-md transition-all duration-400 hover:scale-105 hover:shadow-pink-500/20 hover:bg-white/10 hover:backdrop-blur-md hover:border-pink-400/40 relative overflow-hidden">
            ...
            <div className="absolute inset-0 z-0 pointer-events-none bg-linear-to-br from-pink-800/30 via-purple-800/20 to-blue-800/30 opacity-60 blur-md"></div>
            <div className="relative z-10 w-full h-full flex flex-col items-center">
              <Zap className="w-6 md:w-8 h-6 md:h-8 mb-2 text-pink-300 group-hover:text-pink-200 transition-all duration-300" />
              <h3 className="text-sm md:text-base font-semibold text-white mb-1">
                Real-time Preview
              </h3>
              <p className="text-white/60 text-center text-xs md:text-sm">
          ...
          <div className="group col-span-1 md:col-span-1 row-span-1 bg-neutral-900 border border-white/5 rounded-2xl p-4 md:p-7 flex flex-col items-center shadow-md transition-all duration-400 hover:scale-105 hover:shadow-green-400/20 hover:bg-white/10 hover:backdrop-blur-md hover:border-green-400/40 relative overflow-hidden">
            {/* Background decorativo de la caja */}
            ...
            <div className="relative z-10 w-full h-full flex flex-col items-center">
              <UserCheck className="w-6 md:w-8 h-6 md:h-8 mb-2 text-green-300 group-hover:text-green-200 transition-all duration-300" />
              <h3 className="text-sm md:text-base font-semibold text-white mb-1">
