    ...
    >
      ...
      <div className="relative max-w-6xl mx-auto z-10">
        <div className="text-center mb-12 md:mb-16">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-white mb-4 animate-in slide-in-from-top duration-700">
            Mockups &{" "}
            <span className="bg-linear-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent">
              Layouts
            </span>
          </h2>
          <p className="text-lg md:text-xl text-white/80 max-w-3xl mx-auto animate-in fade-in duration-1000 delay-300">
            Choose from a wide variety of professional device frames and layouts
          </p>
        </div>

        {/* Bentobox grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-7 auto-rows-[minmax(140px,1fr)] md:auto-rows-[minmax(160px,1fr)]">
          {/* Screenshot Mockup - grande horizontal */}
          <div className="group col-span-1 sm:col-span-2 md:col-span-3 row-span-1 bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-4 md:p-8 flex flex-col items-center hover:bg-white/10 hover:scale-105 hover:shadow-pink-500/20 transition-all animate-in slide-in-from-bottom duration-700">
            {/* Usar el icono Camera de Lucide React */}
            <Camera className="w-10 md:w-14 h-10 md:h-14 mb-4 md:mb-6 text-pink-400 group-hover:scale-110 group-hover:rotate-12 transition-all duration-300" />
            <h3 className="text-xl md:text-2xl font-bold text-white mb-4 group-hover:text-pink-200 transition-colors duration-300">
              Screenshot
            </h3>
            <p className="text-white/70 mb-4 md:mb-6 group-hover:text-white/90 transition-colors duration-300 text-sm md:text-base">
