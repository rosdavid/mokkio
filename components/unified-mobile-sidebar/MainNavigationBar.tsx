      ...
      <div className="flex gap-2 justify-center">
        {mainSections.map((section) => (
          <button
            ...
            className={`w-28 min-h-10 rounded-xl relative overflow-hidden select-none active:scale-100 active:shadow-none active:transition-none active:transform-none active:text-current touch-manipulation focus:outline-none focus:ring-0 border ${
