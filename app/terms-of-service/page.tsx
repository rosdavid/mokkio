      ...
      <div className="max-w-4xl mx-auto">
        <div className="space-y-6 text-gray-300">
          ...
          <section>
            ...
            <p className="mb-4">
              Permission is granted to temporarily use Mokkio for personal,
          ...
          <section>
            ...
            <p className="mb-4">
              Our service allows you to create mockups. You retain ownership of
              the content you create, but grant us a license to use it as
          ...
          <section>
            ...
            <p className="mb-4">
              In no event shall Mokkio or its suppliers be liable for any
